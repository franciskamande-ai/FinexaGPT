...
class Transformer(nn.Module):
  def __init__(self,num_heads=12,d_model=768,num_layers=12,dropout=0.1,vocab_size=50000,max_seq_length=512):
    super().__init__()
    self.num_heads = num_heads
    self.d_model = d_model
    ...
    self.blocks = nn.ModuleList([
        TransformerBlock(d_model=d_model,num_heads=num_heads,dropout=dropout,init_method="xavier_uniform")
